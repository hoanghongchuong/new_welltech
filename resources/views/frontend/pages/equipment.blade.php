                ...
                <div class="list-item d-flex">
                    @foreach($posts as $item)
                        <div class="box-item">
                            <div class="box-img">
                                <div class="item-box">
                                    <a href="{{url('trang-thiet-bi/'.$item->slug_vi.'.html')}}" class="vk-project-item__img"><img src="{{$item->image_vi}}" alt=""></a>
                                </div>
                            </div>
                            <p class="name-equipment"><a href="{{url('trang-thiet-bi/'.$item->slug_vi.'.html')}}">{{$item['name_'.$lang]}}</a></p>
                        </div>
                    @endforeach
